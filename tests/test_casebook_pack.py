"""Regression checks for the plume-move-opening-lab casebook."""
...
from casebook.harness import assert_expected, plume_move_opening_lab_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(plume_move_opening_lab_summary(), assert_expected())
