...
`plume-move-opening-lab` is a focused Elixir codebase around build an Elixir toolkit that studies opening behavior through node-edge fixtures, with cycle and reachability reports and synthetic fixtures only. It is meant to be easy to inspect, run, and extend without a hosted service.

## Plume Move Opening Lab Walkthrough
