...
plume-move-opening-lab is a Elixir project for chess and game engines. It focuses on this technical goal: Build an Elixir toolkit that studies opening behavior through node-edge fixtures, with cycle and reachability reports and synthetic fixtures only.
...
The core module exposes a small scoring API. Inputs are simple numeric signals: demand, capacity, latency, risk, and weight. The score uses a threshold of 182, risk penalty 6, latency penalty 4, and weight bonus 2. Tests exercise the public API against the fixture cases in `fixtures/cases.csv`.
